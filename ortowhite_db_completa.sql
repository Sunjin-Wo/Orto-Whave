-- Script de creación de base de datos para OrtoWhite
-- Este script crea la estructura completa de la base de datos incluyendo las columnas para verificación de email
...
-- Tabla de usuarios (incluye campos de verificación de email)
CREATE TABLE users (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
INSERT INTO users (email, password, role_id, first_name, last_name, active, email_verified) 
VALUES (
    'admin@ortowhave.co', 
...
-- Nota: La contraseña hasheada equivale a 'password' en formato bcrypt. 